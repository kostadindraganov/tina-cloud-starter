...
positives_negatives:
  - cons: >+
    ...
    _template: negatives
  - cons: >+
      The loyalty tiers require substantial volume to unlock higher cashback
      levels, making the best rewards accessible mostly to high rollers.

    _template: negatives
  - cons: >+
      While crypto support is strong, fiat withdrawals can have higher minimum
      limits and may take longer to process than crypto ones.

    _template: negatives
  - pros: >+
      Gamblits supports both fiat and crypto payments, making it easy for
      players worldwide to deposit and withdraw securely and flexibly.

    _template: positives
  - pros: >+
      The platform’s cashback-based loyalty ladder rewards consistent play with
      up to 20% daily rebates—no wagering required.

    _template: positives
  - pros: >+
      Gamblits offers multi-tiered welcome packages with generous match
      percentages and free spins, giving new players a strong head start.

    _template: positives
bonuses:
  - bonus_title: Weekly reloads
    bonus_code: NA
    bonus_link: >-
      https://www.affiliatetrackhub.com/visit/?bta=35125&brand=gamblits&utm_campaign=SEO
    bonus_description: |
      Loyalty tiers - up to 20% Cashback
  ...
  - bonus_title: Welcome Bonus
    ...
    bonus_link: >-
      https://www.affiliatetrackhub.com/visit/?bta=35125&brand=gamblits&utm_campaign=SEO
    bonus_description: |
      700% Welcome Package + 100 Free spins
