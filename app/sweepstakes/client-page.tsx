...
interface SweepstakesPostProps  {
  data: GeneratedSweepstakesConnectionQuery;
  variables: SweepstakesConnectionQueryVariables;
  query: string;
}

export default function SweepstakesPageClientPage(props: SweepstakesPostProps) {
  const { data } = useTina({ ...props });
  const { theme } = useLayout();

  return (
    <>
      {data?.sweepstakesConnection?.edges?.map((postData) => {
