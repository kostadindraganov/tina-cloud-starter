...
import { Gallery } from "../../types/sweepstakes";

interface SweepstakesGalleryProps {
  gallery?: ({
    __typename?: "SweepstakesGallery";
    title?: string | null;
    image?: string | null;
  } | null)[] | null;
}

export const SweepstakesGallery: React.FC<SweepstakesGalleryProps> = ({ gallery }) => {
  ...
  return (
    <>
      <h2 className="text-2xl font-bold mb-6">Sweepstakes Gallery</h2>
      ...
      {gallery && gallery.length > 0 ? (
            ...
            return (
              ...
              >
                <div className="relative w-full h-64">
                  <Image
                    src={item.image}
                    alt={item.title ? `Sweepstakes Gallery - ${item.title}` : `Sweepstakes Gallery image ${index + 1}`}
                    fill
        ...
        <div className="p-10 text-center bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-100 dark:border-gray-800">
          ...
          <p className="text-gray-600 dark:text-gray-400 font-medium">No gallery images available for this sweepstakes.</p>
