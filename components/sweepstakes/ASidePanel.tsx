...
export default function ASidePanel({ sweepstakes }: ASidePanelProps) {
  ...
  const ratingBars = getRatingBarPercentage(sweepstakes.player_review_count);
    ...
    <div className="w-full bg-white dark:bg-gray-900 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 mb-10">
      ...
      <div className="relative ">
        <div className="flex">
          ...
          <div className="w-1/2 bg-purple-500 p-8 flex flex-col items-center justify-center">
            <div className="text-8xl font-bold text-white">
              {sweepstakes.sweepstakes_review_count ? 
                (sweepstakes.sweepstakes_review_count % 1 === 0 
                  ? sweepstakes.sweepstakes_review_count 
                  : sweepstakes.sweepstakes_review_count.toFixed(1)) 
                : '8.6'}
            </div>
          ...
          <div className="w-1/2 bg-white dark:bg-gray-800 p-4 flex flex-col justify-center ">
            <div className="text-center">
              ...
              <div className={`uppercase text-3xl font-bold ${getSafetyColor(sweepstakes.sweepstakes_review_count || 8.6)} mt-2`}>
                {getSafetyLevel(sweepstakes.sweepstakes_review_count || 8.6)}
              </div>
        ...
        {/* Star icon overlay */}
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-gray-800 rounded-full p-2 border-4 border-purple-500">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-purple-500" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex flex-col">
            ...
            <div className="flex items-center">
              {[1, 2, 3, 4, 5].map((star) => {
                const rating = sweepstakes.player_review_count ?? 0;
              ...
              <span className="ml-2 text-sm font-medium text-gray-600 dark:text-gray-400">
                ({sweepstakes.player_review_count ? 
                  (sweepstakes.player_review_count % 1 === 0 
                    ? sweepstakes.player_review_count 
                    : sweepstakes.player_review_count.toFixed(1)) 
                  : '0'}/10)
              </span>
            </div>
      ...
      {/* Visit Sweepstakes Button */}
      <div className="p-6 border-b border-gray-200 dark:border-gray-700">
        <Link
          href={sweepstakes.sweepstakes_url || "#"}
          className="flex items-center justify-center py-4 px-6 w-full bg-purple-500 hover:bg-purple-600 text-white hover:text-white text-xl font-bold rounded-md transition-all duration-300 relative overflow-hidden group"
        >
        ...
        <div className="flex justify-between">
          <div className="text-center flex-1">
            ...
            <div className="text-lg font-bold text-gray-800 dark:text-white">
              {sweepstakes.withdrawal_methods?.[0]?.withdrawal_limit_per_day || "€0"}
            </div>
          </div>
          ...
          <div className="text-center flex-1">
            ...
            <div className="text-lg font-bold text-gray-800 dark:text-white">
              {sweepstakes.withdrawal_methods?.[0]?.withdrawal_limit_per_week || "€0"}
            </div>
          </div>
          ...
          <div className="text-center flex-1">
            ...
            <div className="text-lg font-bold text-gray-800 dark:text-white">
              {sweepstakes.withdrawal_methods?.[0]?.withdrawal_limit_per_month || "€0"}
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="group">
            <div className="text-sm text-gray-500 dark:text-gray-400 uppercase tracking-wider font-semibold">
             ...
             <Link
              href={sweepstakes.owner_company_url || "#"} 
              target="_blank"
              >
            <div className="text-xl font-bold text-gray-800 dark:text-white group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
              {sweepstakes.owner || "Versus Odds B.V."}
            </div>
            </Link>
          </div>
      ...
      <div className="group">
            ...
            <div className="text-xl font-bold text-gray-800 dark:text-white group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors">
              {sweepstakes.year_established ? 
                (typeof sweepstakes.year_established === 'string' ? 
                  new Date(sweepstakes.year_established).getFullYear() : 
                  new Date(sweepstakes.year_established).getFullYear()) : 
                "2024"}
            </div>
          </div>
        ...
        {sweepstakes.authorities && sweepstakes.authorities[0]?.all_authorities ? (
          <div className="flex flex-wrap gap-1.5">
            {sweepstakes.authorities[0].all_authorities.split(',').map((authority, index) => (
              <div 
                key={index}
