...
interface CasinoBonusesProps {
  bonuses?: any[] | null; // Use any to accept the TinaCMS generated types
}

export function CasinoBonuses({ bonuses }: CasinoBonusesProps) {
                        ...
                        <div className="border border-grey-400 dark:border-purple-400 rounded-md overflow-hidden">
                          ...
                          >
                            <div className="flex items-center gap-3">
                              <FaGift className="text-2xl text-green-600 dark:text-green-400 mr-2"/>
                      ...
                      <div className="md:col-span-1">
                        <div className="border border-gray-200 dark:border-gray-700 p-5 rounded-md bg-white dark:bg-gray-800">
                          ...
                          <div className="relative">
                            <h3 className="text-xl text-center my-5 font-bold text-green-900 dark:text-green-100">
                              <button 
                                onClick={() => copyToClipboard(bonus.bonus_code || "")}
                                className="border-2 border-grey-600 rounded-md px-4 py-2 inline-flex items-center gap-2 hover:bg-green-50 dark:hover:bg-green-950 transition-colors duration-200 uppercase"
                          ...
                          <Link
                            ...
                            className="w-full bg-green-600 hover:bg-green-700 text-white hover:text-white font-medium py-3 px-4 rounded-md flex items-center justify-center gap-2 mb-5 transition-colors duration-200"
                          >
