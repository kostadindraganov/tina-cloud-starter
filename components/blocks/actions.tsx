...
const buttonColorClasses = {
  ...
  green:
    "text-white bg-green-500 hover:bg-green-600 bg-gradient-to-r from-green-400 to-green-600 hover:from-green-400 hover:to-green-500 dark:from-green-500 dark:to-green-700 dark:hover:from-green-500 dark:hover:to-green-600",
...
const invertedButtonColorClasses = {
  blue: "text-blue-500 bg-white hover:bg-gray-50 bg-gradient-to-r from-gray-50 to-white hover:to-gray-100 dark:text-blue-400 dark:bg-gray-900 dark:from-gray-900 dark:to-gray-800 dark:hover:to-gray-700",
  teal: "text-teal-500 bg-white hover:bg-gray-50 bg-gradient-to-r from-gray-50 to-white hover:to-gray-100 dark:text-teal-400 dark:bg-gray-900 dark:from-gray-900 dark:to-gray-800 dark:hover:to-gray-700",
  green:
    "text-green-500 bg-white hover:bg-gray-50 bg-gradient-to-r from-gray-50 to-white hover:to-gray-100 dark:text-green-400 dark:bg-gray-900 dark:from-gray-900 dark:to-gray-800 dark:hover:to-gray-700",
  red: "text-red-500 bg-white hover:bg-gray-50 bg-gradient-to-r from-gray-50 to-white hover:to-gray-100 dark:text-red-400 dark:bg-gray-900 dark:from-gray-900 dark:to-gray-800 dark:hover:to-gray-700",
  pink: "text-pink-500 bg-white hover:bg-gray-50 bg-gradient-to-r from-gray-50 to-white hover:to-gray-100 dark:text-pink-400 dark:bg-gray-900 dark:from-gray-900 dark:to-gray-800 dark:hover:to-gray-700",
  purple:
    "text-purple-500 bg-white hover:bg-gray-50 bg-gradient-to-r from-gray-50 to-white hover:to-gray-100 dark:text-purple-400 dark:bg-gray-900 dark:from-gray-900 dark:to-gray-800 dark:hover:to-gray-700",
  orange:
    "text-orange-500 bg-white hover:bg-gray-50 bg-gradient-to-r from-gray-50 to-white hover:to-gray-100 dark:text-orange-400 dark:bg-gray-900 dark:from-gray-900 dark:to-gray-800 dark:hover:to-gray-700",
  yellow:
    "text-yellow-500 bg-white hover:bg-gray-50 bg-gradient-to-r from-gray-50 to-white hover:to-gray-100 dark:text-yellow-400 dark:bg-gray-900 dark:from-gray-900 dark:to-gray-800 dark:hover:to-gray-700",
};
              ...
              <Link key={index} href={action.link ? action.link : "/"}>
                <button
                  ...
                  className={`z-10 relative flex items-center px-7 py-3 font-semibold text-lg transition duration-150 ease-out rounded-lg transform focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2 whitespace-nowrap ${
                    parentColor === "primary"
                      ? invertedButtonColorClasses[themeColor as keyof typeof invertedButtonColorClasses] || invertedButtonColorClasses.blue
                      : buttonColorClasses[themeColor as keyof typeof buttonColorClasses] || buttonColorClasses.blue
                  }`}
                >
                  {action.label}
                  {action.icon && (
              ...
              <Link
                ...
                className={`group inline-flex items-center font-semibold text-lg transition duration-150 ease-out ${
                  parentColor === "primary"
                    ...
                    : linkButtonColorClasses[themeColor as keyof typeof linkButtonColorClasses] || linkButtonColorClasses.blue
                }`}
                style={{
